const fs = require('fs');
fs.mkdirSync('C:/Users/Endi Osut/ography-v4/src/app/api/stripe/webhook', {recursive:true});
fs.writeFileSync('C:/Users/Endi Osut/ography-v4/src/app/api/stripe/webhook/route.ts', `import { NextRequest, NextResponse } from 'next/server'
...
`, 'utf8');
console.log('✓ webhook route.ts fixed (lazy Supabase init)');
